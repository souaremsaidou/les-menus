...
menu with Adafruit_HX8357 driver https://github.com/adafruit/Adafruit_HX8357_Library

***/
#ifndef TFT_FEATHERWING_DEF_H
	#define TFT_FEATHERWING_DEF_H
...
namespace Menu {
	  ...
	  class tftFeatherWingOut:public gfxOut {
	    public:
				Adafruit_HX8357& gfx;
				const colorDef<uint16_t> (&colors)[nColors];
		    tftFeatherWingOut(Adafruit_HX8357& gfx,const colorDef<uint16_t> (&c)[nColors],idx_t* t,panelsList &p,idx_t resX=6,idx_t resY=9)
